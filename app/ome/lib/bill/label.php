...
class ome_bill_label
{
    ...
    public $orderLabelsPreset = [
        ...
        'SOMS_EXPRESS_BLACKLIST' => ['label_name' => '黑名单快递', 'label_color' => 'Black', 'label_desc'=>'用户指定了不使用的快递'],
        ...
        'SOMS_DIRECT_MAIL'  => ['label_name' => '直邮', 'label_color' => 'DarkCyan', 'label_desc' => '该订单的运费，平台补贴广告红包，具体请至拼多多商家后台订单详情页查看。'],
